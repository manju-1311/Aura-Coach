    ...
    <div className="flex-1 flex flex-col justify-between px-6 pt-10 pb-6 bg-[#0D0221] text-purple-100 min-h-full overflow-y-auto">
      <div>
        ...
        <div className="mb-6">
          ...
          <p className="text-[14px] text-purple-200/80 mt-1">Log in to pick up where your focus streak left off.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full h-[50px] px-3.5 rounded-[10px] bg-[#13052E] border border-[#4C1D95] focus:border-[#A855F7] focus:ring-1 focus:ring-[#A855F7] text-sm text-white placeholder-purple-300/50 outline-none shadow-[0_0_10px_rgba(168,85,247,0.15)]"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-[#4C1D95] bg-[#13052E] text-[#A855F7] focus:ring-0 cursor-pointer accent-purple-500"
              />
              <span className="text-[12px] text-purple-200/90">Remember me</span>
            </label>

            <button
              type="button"
              onClick={() => setCurrentScreen('reset_password')}
              className="text-[12px] text-fuchsia-400 hover:text-fuchsia-300 hover:underline font-medium cursor-pointer"
            >
              Forgot password?
            </button>
          </div>
        ...
        <div className="flex items-center my-5">
          ...
          <span className="px-3 text-[12px] text-purple-300/70">— or continue with —</span>
          <div className="flex-1 h-[1px] bg-[#4C1D95]/60" />
        </div>

        {/* Single-tap SSO Buttons */}
        <div className="grid grid-cols-2 gap-3">
          <button
            type="button"
            onClick={() => handleSSO('google')}
            className="h-12 rounded-[10px] bg-[#190838] border border-[#4C1D95] hover:border-purple-400 flex items-center justify-center gap-2 text-xs font-semibold text-white transition-colors cursor-pointer shadow-[0_0_10px_rgba(168,85,247,0.1)]"
          >
          ...
          >
            <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
              <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.42c.62-.75 1.04-1.8 0.92-2.85-.9.04-2 0.6-2.65 1.35-.58.67-1.08 1.74-.95 2.77 1.01.08 2.05-.52 2.68-1.27z" />
            </svg>
            <span>Apple</span>
          </button>
        </div>
      ...
      <div className="text-center pt-4">
        <span className="text-xs text-purple-300/70">Don't have an account? </span>
        <button
          onClick={() => setCurrentScreen('signup')}
